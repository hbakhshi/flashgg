...
version="3"
fggRunJobs.py --load data_jobs_forthq.json -d $outdir/data_jobs_${version} -x cmsRun workspaceStd_testThq.py maxEvents=-1 -n 500 -q ${queue} -H -D -P useAAA=1 --no-use-tarball lumiMask=${LM}