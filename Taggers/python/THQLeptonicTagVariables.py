...
lepton_variables=[
    ...
    "muon1_dxy              := ?(muons.size>0)? muons.at(0).getLeadingMuonVertexDxy : -999",
    "muon2_dxy              := ?(muons.size>1)? muons.at(1).getSubleadingMuonVertexDxy : -999",
    "muon1_diphodxy         := ?(muons.size>0)? muons.at(0).getLeadingMuonDiphoVertexDxy : -999",
    "muon2_diphodxy         := ?(muons.size>1)? muons.at(1).getSubleadingMuonDiphoVertexDxy : -999",
    "muon1_dz              := ?(muons.size>0)? muons.at(0).getLeadingMuonVertexDz : -999",
    "muon2_dz              := ?(muons.size>1)? muons.at(1).getSubleadingMuonVertexDz : -999",
    "muon1_diphodz         := ?(muons.size>0)? muons.at(0).getLeadingMuonDiphoVertexDz : -999",
    "muon2_diphodz         := ?(muons.size>1)? muons.at(1).getSubleadingMuonDiphoVertexDz : -999",
