...
generic_variables=[
	...
	"jet_pt6                :=  ? jets.size()>5 ? jetVector[5].pt : -100 ",
	"jet_eta6               :=  ? jets.size()>5 ? jetVector[5].eta : -100 ",
	"jet_phi6               :=  ? jets.size()>5 ? jetVector[5].phi : -100",
	"jet_energy6            :=  ? jets.size()>5 ? jetVector[5].energy : -100 ",
	"jet_bdiscriminant6     :=  ? jets.size()>5 ? jetVector[5].bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -100 ",
	"jet_pt7                :=  ? jets.size()>6 ? jetVector[6].pt : -100 ",
	"jet_eta7               :=  ? jets.size()>6 ? jetVector[6].eta : -100 ",
	"jet_phi7               :=  ? jets.size()>6 ? jetVector[6].phi : -100",
	"jet_energy7            :=  ? jets.size()>6 ? jetVector[6].energy : -100 ",
	"jet_bdiscriminant7     :=  ? jets.size()>6 ? jetVector[6].bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -100 ",
	"jet_pt8                :=  ? jets.size()>7 ? jetVector[7].pt : -100 ",
	"jet_eta8               :=  ? jets.size()>7 ? jetVector[7].eta : -100 ",
	"jet_phi8               :=  ? jets.size()>7 ? jetVector[7].phi : -100",
	"jet_energy8            :=  ? jets.size()>7 ? jetVector[7].energy : -100 ",
	"jet_bdiscriminant8     :=  ? jets.size()>7 ? jetVector[7].bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -100 ",
	"jet_pt9                :=  ? jets.size()>8 ? jetVector[8].pt : -100 ",
	"jet_eta9               :=  ? jets.size()>8 ? jetVector[8].eta : -100 ",
	"jet_phi9               :=  ? jets.size()>8 ? jetVector[8].phi : -100",
	"jet_energy9            :=  ? jets.size()>8 ? jetVector[8].energy : -100 ",
	"jet_bdiscriminant9     :=  ? jets.size()>8 ? jetVector[8].bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags') : -100 ",
	"MetPt                  :=  MetPt ",
	"MetPhi                 :=  MetPhi "
]
